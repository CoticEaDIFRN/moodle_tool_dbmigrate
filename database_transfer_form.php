...
class database_transfer_form extends moodleform {
    ...
    protected function definition() {
        ...
        $mform->addElement('header', 'database', get_string('targetdatabase', 'tool_dbmigrate'));
        ...
        $mform->addElement('header', 'database', get_string('options', 'tool_dbmigrate'));

        $mform->addElement('advcheckbox', 'enablemaintenance', get_string('enablemaintenance', 'tool_dbmigrate'));
        $mform->setType('enablemaintenance', PARAM_BOOL);
        $mform->addHelpButton('enablemaintenance', 'enablemaintenance', 'tool_dbmigrate');

        $this->add_action_buttons(false, get_string('transferdata', 'tool_dbmigrate'));
    }
