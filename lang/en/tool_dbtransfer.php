...
$string['pluginname'] = 'Database migration';
$string['pluginname,tool_dbmigrate'] = 'Database migration';
$string['tool_dbmigrate'] = 'Database migration';
$string['dbmigrate'] = 'Database migration';
